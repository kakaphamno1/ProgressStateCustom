package com.tsolution.progressStateCustom;
...
import com.tsolution.progressStateCustom.components.StateItemDescription;
import com.tsolution.progressStateCustom.components.StateItemNumber;
import com.tsolution.progressStateCustom.listeners.OnStateItemClickListener;
import com.tsolution.progressStateCustom.utils.FontManager;
...
public class StateProgressBar extends View {
    ...
    public enum StateNumber {
        ONE(1), TWO(2), THREE(3), FOUR(4), FIVE(5), SIX(6), ELEVEN(7), EIGHT(8), NINE(9), TEN(10);
        private int value;
    ...
    public void setCurrentComplete(int currentStateNumber) {
